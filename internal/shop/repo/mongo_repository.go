...
//)
//
//// MongoRepository 使用共享 mongox 文档存储持久化 shop 聚合。
...
//}
//
//// Save 按 MongoDB _id 新增或更新 shop 聚合。
//func (r *MongoRepository) Save(ctx context.Context, item *entity.Shop) error {
//	start := time.Now()
...
//}
//
//// FindByID 按 MongoDB _id 加载 shop 聚合。
//func (r *MongoRepository) FindByID(ctx context.Context, id string) (*entity.Shop, error) {
//	start := time.Now()
...
//}
//
//// List 按创建时间排序加载分页 shop 聚合。
//func (r *MongoRepository) List(ctx context.Context, offset int, limit int) ([]*entity.Shop, int64, error) {
//	start := time.Now()
//	filter := bson.M{}
...
//	}
//
//	items := make([]*entity.Shop, 0, len(documents))
...
//}
//
//// Delete 按 MongoDB _id 删除 shop 聚合。
...
//	fields := []zap.Field{
//		zap.String("repository", "shop_mongo"),
...
//}
//
//func toDocument(item *entity.Shop) *dbmodel.ShopDocument {
//	return &dbmodel.ShopDocument{
//		ID:          item.ID,
//		Name:        item.Name,
...
//}
//
//func toDomainFromDocument(document *dbmodel.ShopDocument) *entity.Shop {
//	return &entity.Shop{
//		ID:          document.ID,
//		Name:        document.Name,
